...
const banner2 = cfonts.render((`Melhor bot\n@luanzn.fe`), {
font: 'console',
align: 'center',
gradient: ['cyan', 'blue']
});
...
const upload = async (buffer) => {
  ...
  form.append("file", buffer, {filename: "black-midia." + String(ext), contentType: mime});
  const siteurlupload = "https://blackstorage.store"
  try {
    const { data } = await axios.post(siteurlupload + "/upload", form, {
      headers: form.getHeaders(),
    });
    console.log(data)
    return siteurlupload + data.files[0].url
  } catch (error) {
...
nit = '5519995999218@s.whatsapp.net'
supre = '5519995999218@s.whatsapp.net'
sesc = '5519995999218@s.whatsapp.net'
chyt = '5519995999218@s.whatsapp.net'
